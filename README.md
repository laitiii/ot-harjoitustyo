...
This project is a tower defense game. The goal of the game is to defeat enemies moving along a path by placing towers along the path.


### You can download the latest version from the [releases](https://github.com/laitiii/ot-harjoitustyo/releases)
...
- [Käyttöohje](https://github.com/laitiii/ot-harjoitustyo/blob/main/dokumentaatio/instructions.md)
